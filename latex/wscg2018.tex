...
\begin{figure}
	...
	\begin{minipage}{.16\textwidth}
		...
		(c)
	\end{minipage}
	\caption{User-selected generalized selections highlighted in inverted colors. (a): a segment in the green material; (b): a segment in the red material; (c): a segment in the purple material}
...
\begin{figure}
	...
	(e)
	\end{minipage}
	\caption{User-selected regions and segments on the rendering of a supernova data set; (a) \& (b): User-selected rectangular regions highlighted in inverted colors; (c) \& (d): User-selected generalized segments highlighted in inverted colors; (e): Initial transfer function}
