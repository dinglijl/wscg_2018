...
\autoref{fig:vortex_merged} (d) is the user interface for editing and merging transfer function components. It displays the individual transfer function components with their weights and colors on the left, and the resultant transfer function at the bottom.
