...
We present some results to demonstrate the effectiveness of our approach on the nucleon (voxel dimensions: $ 41 \times 41 \times 41 $), CT-knee (379 $ \times $ 229 $ \times $ 305) data sets, one time-step of a simulated turbulent vortex flow (128 $\times$ 128 $\times$ 128) and one time-step of a simulated supernova (432 $\times$ 432 $\times$ 432) data set.
