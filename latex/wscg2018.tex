...
Based on this weighting, the user can directly modify colors and opacities in the rendred image of the volume data, in a manner analogous to painting a 3D scene.
...
\begin{figure}
	...
	(e)
	\end{minipage}
	\caption{User-selected regions and segments on the rendering of a supernova data set; (a) \& (b): User-selected regions highlighted in inverted colors; (c) \& (d): User-selected segments highlighted in inverted colors; (e): Initial transfer function}
