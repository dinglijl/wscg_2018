...
(d)
	...
	\end{minipage}
	\caption{(a) \& (b): CT-Knee data set and basic TF; (c) \& (d): Volume rendering and TF after blue applied and opacity enhanced for selected region}
