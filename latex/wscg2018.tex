...
Bruckner and Gr{\"o}ller \cite{bruckner_style_2007} presented style transfer functions, which allow the user to specify styles extracted from actual illustrations in the transfer function. Their also curvature information \cite{kindlmann_curvature-based_2003} to improve the illustrative effects, i.e. adjusting the thickness of style-based contours based on the curvature along the viewing direction.
