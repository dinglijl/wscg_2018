...
\begin{figure}
	...
	(e)
	\end{minipage}
	\caption{User-selected regions and segments on the rendering of a supernova data set; (a) \& (b): User-selected rectangular regions highlighted in inverted colors; (c) \& (d): User-selected generalized segments highlighted in inverted colors; (e): The initial transfer function}
